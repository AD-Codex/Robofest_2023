...
void setup() {
  ...
  //attachInterrupt(digitalPinToInterrupt(encoderPin2), updateEncoder_right, FALLING);
  //attachInterrupt(digitalPinToInterrupt(encoderPin3), updateEncoder_left, FALLING);
