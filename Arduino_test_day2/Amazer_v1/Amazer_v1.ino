...
// ---------------------------------------- maze solve ---------------------------------
int maze_size = 5;                      // change vaule based on maze_size

int terminal_maze[ 11][ 11];            // change vaule based on maze_size ( value = maze_size*2 +1 ) 
int edit_terminal_maze[ 5][ 11][ 11];   // change vaule based on maze_size ( value = maze_size*2 +1 ) 
